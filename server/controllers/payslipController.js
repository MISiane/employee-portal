    ...
    for (let i = 0; i < data.length; i++) {
      ...
      try {
        ...
        const payslipData = {
          ...
          late_undertime_amount: roundTo2(parseFloat(row.LATE_UNDERTIME_AMOUNT) || 0),
         ...
         holiday_premium_100_amount: roundTo2(parseFloat(row.HOLIDAY_PREMIUM_100_AMOUNT) || 0),
          holiday_premium_30_amount: roundTo2(parseFloat(row.HOLIDAY_PREMIUM_30_AMOUNT) || 0),
