...
const EditLeaveRequestModal = ({
  ...
  useEffect(() => {
    if (isOpen && leaveRequest) {
      setFormData({
        ...
        regular_days_off: leaveRequest.regular_days_off || "",
      });
  ...
  const handleSubmit = async (e) => {
    ...
    submitData.append("leave_pay_type", "pending");
     submitData.append('regular_days_off', formData.regular_days_off || '');
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                    ...
                    <div className="mb-2 p-2 bg-green-50 rounded-lg flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-green-700">
                          Current file:{" "}
                          {leaveRequest.medical_certificate_filename ||
                            "Medical Certificate"}
                        </span>
                      </div>
                      <a
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Allowed: JPG, PNG, PDF (Max 5MB). Upload a new file to
                          ...
                          >
                            ...
                            {!sufficientBalance && (
                              <span className="block text-xs text-red-600 mt-1">
                                ⚠️ This exceeds your available balance! Admin
                                may approve as "Without Pay".
                              </span>
                            )}
                            {sufficientBalance && (
                              <span className="block text-xs text-green-600 mt-1">
                                ✓ You have sufficient balance. Admin will decide
                                pay type upon approval.
                              </span>
                            )}
                          </p>
                        </>
            ...
            {/* Regular Day Off Field - Add this BEFORE the Date Selection */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Regular Day(s) Off{" "}
              </label>
