              ...
              <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="inline-block bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl px-3 sm:px-5 py-2 sm:py-3">
                      <p className="text-base sm:text-xl md:text-2xl font-extrabold">
                        {birthdayCelebrants[0].first_name}{" "}
                        {birthdayCelebrants[0].last_name}
                      </p>
                      {birthdayCelebrants[0].department && (
                        <p className="text-xs sm:text-sm text-white/80 mt-0.5 sm:mt-1">
                          📍 {birthdayCelebrants[0].department}
                          {birthdayCelebrants[0].position &&
                            ` • ${birthdayCelebrants[0].position}`}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="mt-2 sm:mt-4">
                      <button
                        onClick={() =>
                          setShowCommentsFor(birthdayCelebrants[0])
                        }
                ...
                {birthdayCelebrants.length > 1 && (
                  <div className="space-y-2 sm:space-y-4">
                    <p className="text-sm sm:text-base md:text-lg text-white/95">
                      Please join us in wishing our {birthdayCelebrants.length}{" "}
                      team members a happy birthday today! 🎉
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      {birthdayCelebrants.slice(0, 4).map((celebrant) => (
                        <div
                          key={celebrant.id}
                          className="bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-3"
                        >
                      ...
                      {birthdayCelebrants.length > 4 && (
                        <div className="bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                          <p className="text-xs sm:text-sm">
                            +{birthdayCelebrants.length - 4} more
                          </p>
                        </div>
                      )}
                    </div>
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                {anniversaryCelebrants.length === 1 && (
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="inline-block bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl px-3 sm:px-5 py-2 sm:py-3">
                      <p className="text-base sm:text-xl md:text-2xl font-extrabold">
                        {anniversaryCelebrants[0].first_name}{" "}
                        {anniversaryCelebrants[0].last_name}
                      </p>
                      <p className="text-xs sm:text-sm md:text-md text-white/90 mt-0.5 sm:mt-1">
                        {anniversaryCelebrants[0].celebration_emoji}{" "}
                        {anniversaryCelebrants[0].anniversary_text} with us!{" "}
                        {anniversaryCelebrants[0].celebration_emoji}
                      </p>
                      {anniversaryCelebrants[0].department && (
                        <p className="text-xs sm:text-sm text-white/80 mt-0.5 sm:mt-1">
                          📍 {anniversaryCelebrants[0].department}
                          {anniversaryCelebrants[0].position &&
                            ` • ${anniversaryCelebrants[0].position}`}
                        </p>
                      )}
                    </div>
                ...
                {anniversaryCelebrants.length > 1 && (
                  <div className="space-y-2 sm:space-y-4">
                    <p className="text-sm sm:text-base md:text-lg text-white/95">
                      Please join us in celebrating our team members on their
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                          ...
                          <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="flex-1 text-left">
                              ...
                              <p className="text-[10px] sm:text-xs text-white/90">
                                {celebrant.celebration_emoji}{" "}
                                {celebrant.anniversary_text}
                              </p>
                              {celebrant.department && (
                                <p className="text-[10px] sm:text-xs text-white/80">
                                  📍 {celebrant.department}
                      ...
                      {anniversaryCelebrants.length > 4 && (
                        <div className="bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
                          <p className="text-xs sm:text-sm">
                            +{anniversaryCelebrants.length - 4} more
                          </p>
                        </div>
                      )}
                    </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-1 space-y-1">
                  {urgentAnnouncements.slice(0, 2).map((announcement) => (
                    <p
                      key={announcement.id}
                      className="text-xs sm:text-sm text-orange-700"
                    >
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                <div className="mb-1 flex justify-between text-xs sm:text-sm">
                  ...
                  <span className="font-medium">
                    {stats.leaveBalances.vacation_leave} days
                  </span>
                </div>
                <div className="h-1.5 sm:h-2 w-full rounded-full bg-gray-200">
                  <div
                    ...
                    style={{
                      width: `${(stats.leaveBalances.vacation_leave / 15) * 100}%`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                <div className="mb-1 flex justify-between text-xs sm:text-sm">
                  ...
                  <span className="font-medium">
                    {stats.leaveBalances.sick_leave} days
                  </span>
                </div>
                <div className="h-1.5 sm:h-2 w-full rounded-full bg-gray-200">
                  <div
                    ...
                    style={{
                      width: `${(stats.leaveBalances.sick_leave / 12) * 100}%`,
                    }}
                  ></div>
                </div>
              </div>
            ...
            {recentLeaves.length === 0 ? (
              ...
              <div className="space-y-2 sm:space-y-3">
                {recentLeaves.map((leave) => (
                  <div
                    key={leave.id}
                    className="rounded-lg sm:rounded-xl p-2 sm:p-3 transition hover:bg-[#faf5fb]"
                  >
